...
exports.get_posts = (req, res) => {
    Post.find((err, data) => {
        ...
        res.render('dashboard_king_posts', { posts: data, user: req.user });
    });
}
...
exports.get_new_post = (req, res) => {
    Category.find((err, data) => {
        ...
        res.render('dashboard_king_create_post', { cats: data });
    });
}
...
exports.get_approve = (req, res) => {
    Post.findById(req.params.id, (err1, data) => {
        Category.find((err2, cats) => {
            ...
            res.render('dashboard_king_posts_approve', { post: data, user: req.user, cats: cats, originalAuthor: originalAuthor });
        });
    });
}
...
exports.get_users = (req, res) => {
    Admin.find((err, data) => {
        ...
        res.render('dashboard_king_users', { users: data });
    })
}
